...
# Scenario: Validate the flight duration filter works as expected
#   Given I navigate to site
#   And I accept the cookies
#   And I reveal the search fields
#   And I select return flight type
...
#   And I see the flight results for the specific filters
#   And I see the filters section
#   And I set the flight duration to be a maximum of 5
#   When I click the button to apply the filters //TO-DO
#   Then The flights with the result have 4 flight duration  //TO-DO
